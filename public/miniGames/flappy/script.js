...
function cleanup() {
    ...
    if (animationFrames.move) cancelAnimationFrame(animationFrames.move);
    if (animationFrames.gravity) cancelAnimationFrame(animationFrames.gravity);
    if (animationFrames.create) cancelAnimationFrame(animationFrames.create);
    if (animationFrames.draw) cancelAnimationFrame(animationFrames.draw);
...
function draw() {
    ...
    // Dibujar score (CORREGIDO: faltaban paréntesis)
    ctx.fillStyle = 'white';
